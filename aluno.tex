...
\RequirePackage{varwidth} %quebra de linha do título
%\RequirePackage[table]{xcolor}

\usepackage{array}
\usepackage{colortbl}
\usepackage{hyperref}
\hypersetup{colorlinks=true, colorlinks=true, linkcolor=linkscolor, filecolor=linkscolor, urlcolor=linkscolor}
\usepackage{float}
...
%\usepackage{sphinx}%Tentando retirar este pacote, mas no momento há muitos erros.
\usepackage{tabulary}
\usepackage{geometry}
...
\renewcommand{\thead}{\rowfont{\bfseries \color{black}} % \rowcolor{\currentcolor!80}
}
...
% \include{perspectiva1} 
% \include{perspectiva2}
% \include{funcoes}
% \include{funcao-afim}
% \include{funcao-quadratica}
% \include{estatistica1}
% \include{estatistica2}
% \include{probabilidade1}
% \include{medidas}
% \include{tales}
% \include{semelhanca}
