...
\noindent\includegraphics[width=\linewidth]{{rampa}.png}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=75bp]{{qr_code_quadros}.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=250bp]{{quadros_na_parede1}.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=250bp]{{quadros_na_parede2}.png}
