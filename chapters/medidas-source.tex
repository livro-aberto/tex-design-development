...
\begin{sphinxadmonition}{note}{Atividade: Uma recomendação médica}
...
\begin{itemize}
\item {} 
\textbf{Aplicar conhecimento prévio ou recursos disponíveis para produzir uma estimativa de comprimento ou quantidade.}
...
\textbf{Observações e sugestões: Como esta é a primeira atividade da seção, o principal é que todos percebam que não há como resolver a situação sem uma unidade de medida que possa ser utilizada com praticidade.}

\textbf{A precisão aqui não é importante e, além disso, é desejável que os resultados sejam distintos para que haja a percepção dos elementos que compõem a medição e de seu refinamento: Escolha da unidade, comparação do objeto a ser medido com a unidade, média entre estimativas para refinamento da estimativa, etc.}

\textbf{Recomendamos que os itens apresentados na atividade e suas respostas sejam analisados pelo regente da turma antes da realização da atividade em si.}
\end{sphinxadmonition}
...
\noindent\includegraphics[width=400bp]{{LA_UM_Ativ1_1}.png}
...
\end{enumerate}
\end{sphinxadmonition}
\phantomsection\label{\detokenize{NO103-0:ativ-nome-do-capitulo-nome-da-atividade}}
\begin{sphinxadmonition}{note}{Atividade: A lotação no restaurante}
...
\noindent\includegraphics[width=430bp]{{LA_UM_Ativ2}.png}
\caption{Imagem produzida por Luiz Amorim Duarte}\label{\detokenize{NO103-0:fig-unidades-de-medidas-ativ-a-lotacao-no-reataurante}}\label{\detokenize{NO103-0:id2}}\end{figure}
...
\noindent\includegraphics[width=400bp]{{LA_UM_Ativ2-2}.png}
\caption{Imagem produzida por Luiz Amorim Duarte}\label{\detokenize{NO103-0:fig-unidades-de-medidas-ativ-a-lotacao-no-restaurante2}}\label{\detokenize{NO103-0:id3}}\end{figure}
...
\phantomsection\label{\detokenize{NO103-0:ativ-unidades-de-medida-macas-e-bananas}}
...
Em 1790, a França reúne diversos cientista e cria um sistema métrico, de onde surge o metro, que vem do grego \textit{métron} e significa “o que mede”. Na época, o metro ficou estabelecido como \(\frac{1}{10 \, 000 \, 000} = 10^{-7}\) da distância entre o Pólo Norte e o Equador.

\begin{figure}[H]
\centering
\capstart

\noindent\includegraphics[width=200bp]{{LA_Metro}.png}
...
\textbf{Definição do metro}

\begin{figure}[H]
\centering
\capstart

\noindent\includegraphics[width=500bp]{{LA_UM_OrgI_1}.png}
\caption{Página 24 da 1ª Edição Brasileira do Sistema Internacional de Unidades, disponível em \href{http://www.inmetro.gov.br/inovacao/publicacoes/si\_versao\_final.pdf}{SI INMETRO}}\label{\detokenize{NO103-0:fig-si-definicao-do-metro}}\label{\detokenize{NO103-0:id6}}\end{figure}
...
\noindent\includegraphics[width=500bp]{{LA_UM_OrgI_METRO}.png}
\caption{Página 28 da 1ª Edição Brasileira do SI.}\label{\detokenize{NO103-0:fig-si-simbolo-do-metro}}\label{\detokenize{NO103-0:id7}}\end{figure}
...
\noindent\includegraphics[width=500bp]{{LA_UM_OrgI_MULTeSUB}.png}
\caption{Página 34 da 1ª Edição Brasileira do SI.}\label{\detokenize{NO103-0:fig-si-mutltiplos-submultiplos}}\label{\detokenize{NO103-0:id8}}\end{figure}
...
\noindent\includegraphics[width=500bp]{{LA_UM_OrgI_Validacao}.png}
\caption{DOQ-CGCRE-008 do INMETRO, página 10.}\label{\detokenize{NO103-0:fig-orientacao-para-validacao}}\label{\detokenize{NO103-0:id9}}\end{figure}


\section{Para Saber Mais}
\label{\detokenize{NO103-0:para-saber-mais}}
Para entender o novo pradrão utilizado para o quilograma, recomendamos o video \href{https://youtu.be/Oo0jm1PPRuo}{How We’re Redefining the Kg} da Veritasium e a matéria “\href{https://brasil.elpais.com/brasil/2018/11/13/ciencia/1542109733\_360096.html}{Aprovada a nova definição universal do quilograma}”, da revista eletrônica \textit{EL PAÍS Brasil}, sobre o mesmo assunto, publicada por Bruno Martín.


\section{Explorando: Medidas, Informática e informação}
...
\begin{sphinxadmonition}{note}{Atividade: Compra no Exterior}
...
\begin{enumerate}
\item {} 
“\textit{Screen Size}” refere-se ao tamanho da tela. A unidade apresentada para esse tamanho é “\textit{in}”. Pesquise e descreva que unidade é essa e qual o valor dela em centímetros?

\item {} 
“Item dimensions”, em um outro trecho da propaganda, aparece acompanhado da sigla \textit{L x H x W: Length x height x width}, que significa Comprimento x Altura x Largura. Determine essas dimensões, em centímentros e para cada um dos produtos.
...
\item {} 
“\textit{Item weight}”  é o peso do produto. A unidade utilizada na tabela é o “\textit{lbs}”. Pesquise e diga qual é o nome dessa unidade de massa, em inglês e em português. Em seguida, dê a equivalência dela em gramas.
...
\begin{sphinxadmonition}{note}{Atividade: Fotos do Feriadão}

\begin{sphinxadmonition}{note}{Para o professor}

\textbf{Objetivo específico:} Aplicar os resultados dos endereços de busca sobre as unidades de medidas na resolução de uma situação problema.

\textbf{Observações e sugestões:} O objetivo principal desta atividade é a capacidade de trabalhar com as principais unidades de medida da informática, seus múltiplos e submúltiplos. Para que a atividade não recaísse em mera conversão, utilizamos como cenário a captura de imagens por vias digitais. Algo que, até o momento, não é tratado no Sistema internacional de medidas, uma vez que o tamanho das imagens depende muito da tecnologia empregada e como cada empresa tem a sua, esses valores variam bastante. É por isso que a pesquisa destas unidades é orientada apenas pelas opções oferecidas em cada questão. Mesmo assim, algumas explicações a mais são oferecidas nas respostas.
\end{sphinxadmonition}
...
\noindent\includegraphics[width=430bp]{{LA_MII_Ativ2_Pixel}.png}
\caption{Imagem elaborada por Luiz Amorim Duarte}\label{\detokenize{NO103-1:fig-pixel}}\label{\detokenize{NO103-1:id6}}\end{figure}
...
\item {} 
Blu-Ray e Pendrive, uma vez que as fotos tem 15 GB no total.

\item {} 
4K significa que cada foto da filmagem tem \(3\,840 \times 2\,160\) pixels, ou seja, aproximadamente \(8\) MP.
\begin{quote}

Assim como o pixel, 4K não consta no Sistema Internacional de Unidades. Essa “medida” informa mais sobre a qualidade de um vídeo quando ampliado em telas, monitores ou projetores, ou seja, há mais nitidez, naturalidade e, consequentemente, menos ou nenhuma distorção.
\end{quote}
...
\noindent\includegraphics[width=400bp]{{380-resolutions4k}.jpg}
...
\noindent\includegraphics[width=150bp]{{LA_UM_Pot2Eletronica}.png}
\caption{Imagem recortada por Luiz Amorim Duarte, da página 34 do SI, disponível em \url{http://www.inmetro.gov.br/inovacao/publicacoes/si\_versao\_final.pdf} .}\label{\detokenize{NO103-1:fig-pag34-canto-direito-rodape-si}}\label{\detokenize{NO103-1:id9}}\end{figure}


\section{Explorando: Grandezas Compostas}
...
\textbf{(EM13MAT314)}  Resolver e elaborar problemas que envolvem grandezas compostas, determinadas pela razão ou pelo produto de duas outras, como velocidade, densidade demográfica, energia elétrica etc.
...
\textbf{(EF07MA17)} Resolver e elaborar problemas que envolvam variação de proporcionalidade direta e de proporcionalidade inversa entre duas grandezas, utilizando sentença algébrica para expressar a relação entre elas.

\textbf{(EF09MA08)} Resolver e elaborar problemas que envolvam relações de proporcionalidade direta e inversa entre duas ou mais grandezas, inclusive escalas, divisão em partes proporcionais e taxa de variação, em contextos socioculturais, ambientais e de outras áreas.
...
\phantomsection\label{\detokenize{NO103-2:ativ-unidades-medida-e-og-imc}}
...
\end{enumerate}
\end{sphinxadmonition}
\phantomsection\label{\detokenize{NO103-2:ativ-unidades-medida-e-og-pib}}
\begin{sphinxadmonition}{note}{Atividade: PIB}
...
\end{enumerate}
\end{sphinxadmonition}
\phantomsection\label{\detokenize{NO103-2:ativ-unidades-medida-e-og-densdemo}}
\begin{sphinxadmonition}{note}{Atividade: Densidade Demográfica}
...
\textbf{Observações e sugestões:} Nesta atividade o estudante terá a porotunidade de avaliar a relação que existe entre as grandezas envolvidas de um modo que julgamos importante: uma das grandezas tendo valores iguais e o impacto que isso gera na análise.
\end{sphinxadmonition}
...
\end{enumerate}
\end{sphinxadmonition}
\phantomsection\label{\detokenize{NO103-2:ativ-unidades-medida-e-og-flutuabilidade}}
\begin{sphinxadmonition}{note}{Atividade: Flutuabilidade}
...
\section{Explorando: Representação, Conceito numérico e Precisão}
...
\noindent\includegraphics[width=200bp]{{Not_Cientif_cel_1}.jpeg}
...
\phantomsection\label{\detokenize{NO103-3:sub-ativ-macro}}
\begin{sphinxadmonition}{note}{Atividade: O Macro}
...
\item {} 
No item “c” alguns alunos podem possuir smartphones que a calculadora permitirá a digitação dos \(18\) algarismos.
...
\noindent\includegraphics[width=300bp]{{via_lactea}.jpg}
...
\noindent\includegraphics[width=200bp]{{Not_Cientif_cel_2}.jpeg}
...
\item {} \phantomsection\label{\detokenize{NO103-3:id4}}
\begin{figure}[H]
\centering

\noindent\includegraphics[width=200bp]{{Not_Cientif_cel_2}.jpeg}
\label{\detokenize{NO103-3:id4}}\end{figure}
...
\end{enumerate}
\end{sphinxadmonition}
\phantomsection\label{\detokenize{NO103-3:sub-ativ-micro}}
...
\noindent\includegraphics[width=400bp]{{dna_1}.jpg}
...
\item {} 
Usando a \textbf{calculadora científica} do seu smarthphone, digite o diâmetro do DNA, em metros, na forma de notação científica. {[}\textit{Dica: Use a tecla de potência, em algumas calculadoras ela está representada pela tecla em destaque da figura abaixo.}{]}

\begin{figure}[H]
\centering
\capstart

\noindent\includegraphics[width=300bp]{{Not_Cientif_cel_4}.jpg}
...
\sphinxattableend\end{savenotes}
\end{sphinxlegend}
\label{\detokenize{NO103-3:id6}}\label{\detokenize{NO103-3:id14}}\end{figure}
...
\begin{enumerate}
\item {} 
\(0\text{,}000\, 000\, 000\, 1 \times 20 = 0\text{,}000\, 000\, 002\) m.
...
\noindent\includegraphics[width=200bp]{{Not_Cientif_cel_3}.jpeg}
\caption{Expoente Negativo}\label{\detokenize{NO103-3:id7}}\label{\detokenize{NO103-3:id15}}\end{figure}
...
\item {} 
\(\frac{2 \times 10^{-5}}{2 \times 10^{-9}}=\frac{10^{-5}}{10^{-9}}=10^{-5-(-9)}=10^{9-5}=10^4=10\, 000\) vezes.
...
\noindent\includegraphics[width=200bp]{{Not_Cientif_cel_5}.jpeg}
\caption{Operações com Notação Científica}\label{\detokenize{NO103-3:id8}}\label{\detokenize{NO103-3:id16}}\end{figure}
...
\section{Organizando Ideias: Notação Científica e Ordem de Grandeza}
...
\noindent\includegraphics[width=200bp]{{Not_Cientif_Celular_x}.jpeg}
\caption{Notação Científica}\label{\detokenize{NO103-4:fig-coloque-aqui-o-nome}}\label{\detokenize{NO103-4:id2}}\end{figure}
...
\noindent\includegraphics[width=200bp]{{Not_Cientif_Celular_xx}.jpeg}
\caption{Notação Científica}\label{\detokenize{NO103-4:id1}}\label{\detokenize{NO103-4:id3}}\end{figure}
...
\section{Explorando: Medição e Exatidão, Algarismos Significativos \& Medidas Irracionais}
...
\phantomsection\label{\detokenize{NO103-5:sub-ativ-algsig}}
...
\section{Organizando as Ideias: Algarismos Significativos}
...
Já nos itens ‘b’, ‘c’ e ‘d’, de posse de um instrumento mais preciso (régua milimetrada) pudemos inferir que a medida do lápis é um número entre \(9\text{,}13\) e \(9\text{,}15\).  Se assumíssemos a medida como sendo \(9\text{,}15\) cm, teremos que \(9\), \(1\) e \(5\) são \textbf{algarismos significativos} onde o \(9\) e \(1\) são os \textit{algarismos de certeza} e o \(5\) é o \textit{algarismo duvidoso}.

Já no item ‘f’ temos como medida, por exemplo, \(9\text{,}140\) cm. Onde  \(9\), \(1\), \(4\) e \(0\) são \textbf{algarismos significativos}, com \(9\),  \(1\) e \(4\) como os \textit{algarismos de certeza} e o \(0\) é o \textit{algarismo duvidoso}.
...
\phantomsection\label{\detokenize{NO103-5:sub-ativ-pitagoras}}
...
\noindent\includegraphics[width=300bp]{{corresp_Q_em_P}.jpg}
...
\(2)\) \textit{A impossibilidade da correspondência:} \textbf{Pontos da reta com Racionais} (\(P\) \(\not \to\) \(\mathbb{Q}\))
\end{sphinxadmonition}
...
\noindent\includegraphics[width=200bp]{{pit_1}.jpg}
...
\noindent\includegraphics[width=200bp]{{pit_2}.jpg}
...
\end{enumerate}
\end{sphinxadmonition}
\phantomsection\label{\detokenize{NO103-5:sub-ativ-irracional}}
\begin{sphinxadmonition}{note}{Atividade: Um resultado intrigante}
...
\noindent\includegraphics[width=200bp]{{z1_irracional}.jpg}
...
\item {} 
Será que o número encontrado acima é um número racional? Se pudermos dividir esta unidade por um número suficientemente grande, digamos \(b\) , cada pedacinho mediria portanto \(\frac{1}{b}\). Seria possível escolher convenientemete um número inteiro \(a\) desses pedacinhos de modo a “preencher” a diagonal, ou seja, de modo que \(a\) multiplicado por \(\frac{1}{b}\) desse exatamente o valor da diagonal do quadrado encontrado no item anterior?
...
Um número racional é todo número que puder ser escrito na forma \(\frac{\mathbf{a}}{\mathbf{b}}\), onde \(a\) e \(b\) são números inteiros e \(b \neq 0\). Vamos analisar essa definição fazendo algumas observações:
\begin{quote}
\begin{enumerate}
\item {} 
...
\item {} 
Por que \(b \neq 0\)?  Pelo simples fato de não existir divisão por zero! Lembre-se que uma fração é também uma razão, uma comparação que quer saber quantas vezes precisaríamos considerar o denominador como parcelas de uma soma, para obter o numerador. Em símbolo, \(\frac{a}{b}=n \Leftrightarrow a = n \cdot b\). Para números inteiros, \(a\) e \(b\), precisamos considerar que pode haver algum resto \(r\) depois de considerarmos uma quantidade \(q\) de parcelas iguais a \(b\), ou seja, \(a = b \cdot q + r\). Nesse contexto, considerar \(b=0\) tira o sentido da pergunta original, pois para qualquer quantidade \(q\) de parcelas, \(b\cdot q = 0\).
...
\noindent\includegraphics[width=400bp]{{fracao_equivalente_2}.jpg}
\caption{Frações Equivalentes}\label{\detokenize{NO103-5:id9}}\label{\detokenize{NO103-5:id19}}\end{figure}

O exemplo mostra que a fração \(\frac{1}{2}\) é a forma irredutível das frações \(\frac{2}{4}\); \(\frac{3}{6}\); \(\frac{4}{8}\); \(\frac{5}{10}\); …

Portanto, para garantirmos uma representação mais consistente de número racional \(\frac{\mathbf{a}}{\mathbf{b}}\), devemos adotar sua forma irredutível, na qual \(a\) e \(b\) sejam primos entre si, ou seja, \(mdc(a,b) = 1\), ou melhor dizendo, que se decompormos \(a\) e \(b\) em fatores primos, eles não possuirão fatores em comum.
...
\section{Praticando: a seção “Qual é a medida?”}
\label{\detokenize{NO103-A:praticando-a-secao-qual-e-a-medida}}\label{\detokenize{NO103-A::doc}}
\textbf{Questão 1) (UERJ 99)} João mediu o comprimento do seu sofá com o auxílio de uma régua.

\begin{figure}[H]
\centering
\capstart

\noindent\includegraphics[width=200bp]{{sofauerj99}.bmp}
\caption{Prova de acesso UERJ 1999}\label{\detokenize{NO103-A:fig-uerj99-sofa}}\label{\detokenize{NO103-A:id1}}\end{figure}
...
\textbf{Questõ 2)} Terra Ronca, interior de Goiás, Brasil, é um lugar famoso pelas galerias  que adentram as montanhas.
...
\textbf{Questão 3) (UERJ 2000)} Leia atentamente os quadrinhos.
...
\textbf{Questão 4) (UERJ 2001)} Os 4,5 bilhões de anos de existência da Terra podem ser reduzidos a apenas 1 ano, adotando-se a seguinte escala:
...
\textbf{Questão 5)} Em um site de memes, encontra-se a imagem a seguir, que brinca com os prefixos do SI:
...
Perceba que a ideia é considerar uma unidade chamada \textit{peuta}, que é a menor das imagens. Depois as ampliações recebem os prefixos do SI: kilo, Mega, Giga e Tera, para formar a palavra \textit{TERAPEUTA}.
\begin{enumerate}
\item {} 
...
\section{Praticando: da seção Medidas, Informática e Informação}
...
\section{Praticando: da seção Grandezas Compostas}
...
\textbf{Questão 3)} Observe o quadro a seguir:
\begin{quote}
...
\textbf{Questão 4)} O quadro a seguir apresenta a densidade absoluta, também chamada de massa específica de algumas substâncias, nas condições padrão de temperatura e pressão.
\begin{quote}
...
\textbf{Questão 6)} Em cada item a seguir complete as lacunas, representando os números do texto em Notação Científica:
\textless{}\textless{}\textless{}\textless{}\textless{}\textless{}\textless{} HEAD
\begin{enumerate}
\item {} 
