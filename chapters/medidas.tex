\chapterillustration{abertura-medidas}{abertura-medidas-professor}
...
\chapterbecause{Planejamento de consumo familiar, cumprimento de horários, comparação e aquisição de bens de consumo, são apenas algumas das situações do cotidiano de uma pessoa comum. Em todas elas unidades de medida, estimativas ou medições precisam ser conhecidas, manipuladas ou obtidas. 
...
% Autores
\autorum{Bruno Viana (Colégio Pedro II)}
\autordois{Luiz Amorim Duarte}
\autortres{Maria de Fátima}
...
\autordacapa{Taneli Lahtinen}{Unsplash}{https://unsplash.com/photos/g_LKoKQNr44}
\versao{1.0}
...
\noindent\includegraphics[width=145bp]{{a1f1}.jpg}
...
\else
\noindent\includegraphics[width=230bp]{{via_lactea}.jpg}
\fi
