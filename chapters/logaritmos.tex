\chapterillustration{abertura-log.jpg}{abertura-log-prof.jpg}

\chapterwhat{Conceito de logaritmo.
...
\chapterbecause{Os logaritmos estão presentes em problemas de natureza exponencial sempre que a incógnita aparece no expoente. Esse tipo de questão é relevante em muitos problemas práticos como,  por exemplo, para calcular em quanto tempo uma dívida no cartão de crédito dobrará seu valor.
...
\autorum{Márcio Rostirolla Adames (UTFPR)}
\autordois{Rose Elizangela Martins Pedrosa (SEED - PR)}

\revisorum{Wanderley Rezende (UFF)}

\graficos{Márcio Rostirolla Adames}

\versao{1.0}

\autordacapa{EduardoMSNeves (adaptada)}{Wikimedia Commons}{https://pt.wikipedia.org/wiki/Ficheiro:Pedra_Azul_Milky_Way.jpg}
...
\begin{figure}[H]
\centering
\noindent\fbox{\includegraphics[height=25mm]{{AelevadoB}.png}}
\hspace{15mm}
...
\includegraphics[width=0.75\linewidth]{Sismografo.png}
...
\includegraphics[width=.175\linewidth]{QRcode_mult_constante.png}
...
\includegraphics[width=.75\linewidth]{Bitcoin_linear.png}
...
\includegraphics[width=.8\linewidth]{Bitcoin_log.png}
...
\includegraphics[width=.875\linewidth]{World_linear.png}
...
\includegraphics[width=.875\linewidth]{World_log.png}
...
\includegraphics[width=.2\linewidth]{QRcode_ajuste_curvas.png}
...
\ifnum \aluno=1
\begin{center}
\includepdf[angle=-90, center]{Ruler.pdf}
\end{center}
\else
\begin{center}
\includepdf[angle=-90, offset = 0mm 2mm, center]{Ruler.pdf}
\end{center}
\fi
