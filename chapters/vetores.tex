...
% % \noindent\includegraphics{{Homotetia_1}.png}
% \caption{Créditos: foto do cenário, \href{http://www.publicdomainpictures.net/view-image.php?image=102769\&picture=empty-road-in-american-west}{Ken Kistler}, o carro foi modificado \href{https://www.google.com.br/search?client=ubuntu\&hs=jK5\&channel=fs\&dcr=0\&biw=1198\&bih=617\&tbs=sur\%3Afmc\&tbm=isch\&sa=1\&q=car+drawing+black+and+white+front+beatle\&oq=car+drawing+black+and+white+front+beatle\&gs\_l=psy-ab.3...24087.27803.0.28006.17.12.5.0.0.0.110.1153.8j4.12.0....0...1.1.64.psy-ab..0.0.0....0.xEeDoYiAMAQ\#imgrc=OhvywkBoPce0dM:}{daqui}}\label{\detokenize{GE101-1A:id3}}\end{figure}
...
% \noindent\includegraphics[width=200bp]{{vetores-iguais}.png}
% \end{figure}
...
% % Contudo, da \hyperref[\detokenize{GE101-A:fig-interlagos-corrida}]{\Fref{\detokenize{GE101-A:fig-interlagos-corrida}}} pode-se observar que a velocidade média no intervalo \([6,7]\) é \(\vec{v_6}=(0,1)\) e como do item a) a velocidade média no intervalo \([5,6]\) é  \(\vec{v_5}=(1,1)\), podemos calcular a aceleração média em \([5,6]\) como a diferença
% % \begin{equation*}
% % \begin{split}\vec{a} = \vec{v_6} - \vec{v_5} = (0,1) - (1,1) = (-1,0).\end{split}
% % \end{equation*}
% % Parte III
...
\phantomsection\label{\detokenize{GE101-A:fig-interlagos-corrida}}
\begin{figure}[H]
\centering

\noindent\includegraphics[width=380bp]{{Interlagos}.png}
\label{\detokenize{GE101-A:fig-interlagos-corrida}}\end{figure}
