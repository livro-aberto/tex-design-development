...
\begin{texto}
{
Esta seção é focada em estruturas de repetição, como o \ver|enquanto|, que já usamos em problemas anteriores. O objetivo aqui é salientar o poder desse recurso para realizar tarefas que poderiam ser muito monótonas, e sujeitas a erro, se feitas à mão.
...
\explore{Usando o computador para jogar dados}
\label{comp-exp8}
\begin{texto}
{
