...
\end{answer}
\begin{sugestions}{Simetrias - Exercícios}
{
\tcbsubtitle{Exercício 1}
...
\adjustbox{valign=t}
{
\includegraphics[width=.9\linewidth]{transformacoes94}
}
\end{enumerate}
}{0}
\end{answer}
...
\includegraphics[width=.6\linewidth]{transformacoes101}
\caption{}
...
\includegraphics[width=\linewidth]{transformacoes102}
\end{figure}
...
\includegraphics[width=.675\linewidth]{transformacoes103}
\end{figure}
...
\includegraphics[width=.8\linewidth]{transformacoes106}
\end{figure}
...
\includegraphics[width=.8\linewidth]{transformacoes107}
\end{figure}
...
\item \adjustbox{valign=t}
{
\includegraphics[width=.5\linewidth]{transformacoes108}
}
 
\item \adjustbox{valign=t}
{
\includegraphics[width=.5\linewidth]{transformacoes109}
}
 
\item \adjustbox{valign=t}
{
\includegraphics[width=.5\linewidth]{transformacoes110}
}
\end{multicols}  
\end{enumerate}
...
\item \adjustbox{valign=t}
{
\includegraphics[width=.6\linewidth]{transformacoes111}
}
...
\includegraphics[width=.8\linewidth]{transformacoes163}
\end{figure}

\begin{figure}[H]
\centering

\includegraphics[width=.8\linewidth]{transformacoes164}
\end{figure}
