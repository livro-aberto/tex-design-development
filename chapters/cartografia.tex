\chapterillustration{./abertura-cartografia}{./abertura-cartografia-professor}

\chapterwhat{Projeções cartográficas. Classificação das projeções cartográficas quanto à superfície de projeção (planas, cônicas e cilíndricas) e quanto as propriedades (equivalentes, equidistantes, conformes e afiláticas).}
...
% Revisores
\revisorum{Lhaylla Crissaff (UFF)}

\autordacapa{Clay Banks}{Unsplash}{https://unsplash.com/photos/b5S4FrJb7yQ}
\versao{1.0}
...
{Apesar da resposta ser pessoal, \cite{Nardi} apontam que  os alunos poderão esboçar  uma das seguintes possibilidades: 
 ...
 \begin{figure}[H]
	\centering
		\includegraphics[width=.6\linewidth]{{resp_astro}.png}
	\end{figure}
...
{Parte 1: Visto que na primeira rota é obrigatório passar pela Europa, o trajeto se torna muito maior do que ele se ele apenas atravessasse o pacífico e chegasse ao destino (Nogliki) pelo caminho mais curto. Porém, alguma falha na programação do aplicativo impede de fazer a representação correta, que seria aproximadamente esta:
	...
	\includegraphics[width=.6\linewidth]{{cartografia-professor1}.png}
	\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.28\textwidth]{{carto12}.jpg}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.38\textwidth]{{carto11}.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.325\textwidth]{{carto5}.jpg}
...
Um determinado ponto da superfície da Terra é obtida pela interseção de um meridiano e um paralelo (\hyperref[ponto]{Figura \ref{ponto}}). 
...
\begin{figure}[H]
\centering
\includegraphics[width=0.375\textwidth]{{bala2}.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.375\textwidth]{{bala3}.png}
...
\begin{sugestions}{Projetando a esfera em uma superfície cilíndrica}
{
  ...
  \includegraphics[width=.5\linewidth]{{cartografia-professor17}.png}
  \end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.375\textwidth]{{garrafa}.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.375\textwidth]{{cilindro1}.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.375\textwidth]{{cilindro2}.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.375\textwidth]{{cilindro3}.png}
...
\begin{sugestions}{Projetando a esfera no plano}
{
  ...
  \includegraphics[width=.35\linewidth]{{cartografia-professor18}.png}
  \end{figure}
...
A Projeção Plana Gnomonica (também conhecida como Projeção Plana Central) é do tipo afilática, onde os círculos máximos são representados como linhas retas (\hyperref[p_gno]{Figura \ref{p_gno}}).
 ...
 \begin{figure}[H]
\centering
\includegraphics[width=0.325\textwidth]{{plana_gnomo}.png}
...
\begin{sugestions}{Projetando a esfera em uma superfície cônica}
{
  ...
  \includegraphics[width=.35\linewidth]{{cartografia-professor19}.png}
  \end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.475\textwidth]{{tisslambcon}.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.45\textwidth]{{conica_lam}.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.65\textwidth]{{cone_simples}.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=.85\textwidth]{{pratica 3}.png}
\caption{Figura 1.}
\label{prati1}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=.85\textwidth]{{pratica4}.png}
\caption{Figura 2.}
\label{prati1}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.475\textwidth]{{pratica5}.png}
...
\tcolor{} & \tcolor{Descreva os meridianos} & \tcolor{Quais distorções você percebe?} & \tcolor{Por que usar essa projeção?} \\
\hline
...
\hline
\tcolor{} & \tcolor{Descreva os meridianos} & \tcolor{Quais distorções você percebe?} & \tcolor{Por que usar essa projeção?} \tabularnewline
\hline
Globo & & & \\[5.15em]
\hline
Mercator & & & \\[5.15em]
...
\begin{answer}{Exercícios}
{
	...
	\adjustbox{valign=t}
	{
	\includegraphics[width=.9\linewidth]{{cartografia-professor20}.png}
	}
...
\begin{answer}{Exercícios}
{
	...
	\adjustbox{valign=t}
	{
	\includegraphics[width=.9\linewidth]{{cartografia-professor21}.png}
	}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.2\textwidth]{{cartografia38}.png}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.675\textwidth]{{cartografia390}.png}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=350bp]{{cartografia44}.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=250bp]{{cartografia45}.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=350bp]{{cartografia46}.png}
