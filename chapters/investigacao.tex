\chapterillustration{./abertura-investigacao}{./abertura-investigacao-professor}

\chapterwhat{Taxas, índices e indicadores sociais, econômicos e ambientais. Compreensão de aspectos teóricos e práticos dessas informações, com uma metodologia que busca a análise de situações reais, tanto locais quanto globais.}

\chapterbecause{Na era da informação, somos inundados por dados sobre os mais diversos fenômenos da realidade. Compreender a obtenção e organização desses dados torna-se importante para planejarmos ações que busquem uma organização social mais justa e sustentável.} 
...
% Autores
\autorum{Thiago Ferraiol}
\autordois{Priscila Santos}
\autortres{Rodrigo Belli}
...
\autordacapa{Clay Banks}{Unsplash}{https://unsplash.com/photos/U0-r0JMypE0}
\versao{1.0}
...
\centering
\includegraphics[width=350bp]{investigacao1}
...
\begin{table}[H]
\centering
\begin{tabular}{|>{\centering}m{.2\textwidth}|>{\vspace{2.5pt}}m{.6\textwidth}<{\vspace{2.5pt}}|}
\hline
...
\begin{tabular}{|>{\vspace{2.5pt}}m{.3\textwidth}<{\vspace{2.5pt}}|>{\vspace{2.5pt}}m{.2\textwidth}<{\vspace{2.5pt}}|>{\vspace{2.5pt}}m{.4\textwidth}<{\vspace{2.5pt}}|}
\hline
...
\begin{figure}[H]
\centering
\includegraphics[width=390bp]{investigacao5}
...
\begin{figure}[H]
\centering
\includegraphics[width=275bp]{investigacao6}
...
\begin{table}[H]
\centering
\begin{tabular}{|>{\vspace{2.5pt}}m{.6\textwidth}<{\vspace{2.5pt}}|c|c|c|}
\hline
