...
label(rotate(90)*scale(.6)*"Plano Frontal",(0,.5), align=W);
label(rotate(90)*scale(.6)*"Plano Horizontal",shift(0,-1)*(0,.5), align=W);
label(rotate(90)*scale(.6)*"Plano Lateral",(2.1,.5));
