...
\tcbsubtitle{EF05MA14} Utilizar e compreender diferentes representações para a localização de objetos no plano, como mapas, células em planilhas eletrônicas e coordenadas geográficas, a fim de desenvolver as primei-ras noções de coordenadas cartesianas.
\tcbsubtitle{EF09MA13} Demonstrar relações métricas do triângulo retângulo, entre elas o teorema de Pitágo-ras, utilizando, inclusive, a semelhança de triângulos.
...
\tcbsubtitle{EF09GE15}Comparar e classificar diferentes regiões do mundo com base em informações populaci-onais, econômicas e socioambientais representadas em mapas temáticos e com diferentes projeções cartográ-ficas.
\end{objetivos}
...
\tcbsubtitle{EM12MT03} Utilizar a noção de semelhança para compreender as razões trigonométricas no triân-gulo retângulo, suas relações em triângulos quaisquer e aplicá-las em situações como o cálculo de medidas inacessíveis, entre outras.
\end{objetivos}
...
\begin{ObjetivoEsp}{Reconhecer que a superfície terrestre pode ser representada como uma esfera}
{
...
\end{resposta}
\begin{ObjetivoEsp}{Observando a paisagem}
{
	\begin{itemize}
...
\end{Recomenda}
\begin{resposta}{Que números são esses?}
{Exemplo de resposta:
...
\begin{ObjetivoEsp}{Planificando o globo}
{
...
\begin{ObjetivoEsp}{O caminho mais curto}
{
...
\begin{ObjetivoEsp}{Observando mapas}
{
  \begin{itemize}
...
\end{Recomenda}
\begin{resposta}{Um mapa para o mundo}
...
\end{ObjetivoEsp}
\begin{Recomenda}{Projetando a esfera no cilindro}
{
...
\end{Recomenda}
\clearmargin
\begin{resposta}{Sobre mapas e localizações}
{
\textbf{Parte 1}
\begin{enumerate}
\item Letra a
...
\end{task}
\clearpage
\begin{ObjetivoEsp}{Sobre coordenadas cartográficas}
{
  Essa atividade tem por objetivo aplicar os conceitos de projeções cartográficas e distorções.
}{1}{0}
\end{ObjetivoEsp}
\begin{Recomenda}{Sobre coordanadas cartográficas}
{
  ...
  Observamos que essa atividade foi adaptada de Bortolossi e de Almeida Junior (2016).

  \textbf{Obs}.: Faltam as respostas, pois não conseguimor abrir o aplicativo.
}{1}{0}
\end{Recomenda}
\begin{ObjetivoEsp}{Comparando projeções cartográficas}
{
  \begin{itemize}
...
\begin{ObjetivoEsp}{Comparando as projeções cartográficas com o globod}
{
 \begin{itemize}
...
{1}{0}
\end{Recomenda}
\begin{resposta}{Comparando as projeções cartográficas com o globo}
{
\begin{table}[H]
\centering
