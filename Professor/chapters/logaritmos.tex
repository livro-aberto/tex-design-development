...
\begin{objectives}{Crescimento logarítmico}
{
	...
	\tcbsubtitle{Brasil e Reino Unido na Pandemia}
	\begin{itemize}
...
{A escala de Magnitude de Momento Sísmico é a escala mais utilizada para eventos de grande magnitude atualmente.}{1}{1}
\end{sugestions}
\clearmargin
...
\clearmargin
\marginpar{\def\currentcolor{cor1}}
\begin{answer}{Exercícios}
{\exerciselist
\begin{enumerate}
...
\begin{objectives}{Sem ferramentas de cálculo...}
{
	\begin{itemize}
...
\end{objectives}
\begin{sugestions}{Sem ferramentas de cálculo...}
{
